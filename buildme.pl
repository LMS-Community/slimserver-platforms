...
my $dirsToExcludeForMacOSX = "5.14 5.20 5.22 5.24 5.26 i386-freebsd-64int i386-linux x86_64-linux x86_64-linux-gnu-thread-multi MSWin32 i86pc-solaris-thread-multi-64int arm-linux armhf-linux powerpc-linux sparc-linux";
...
my $dirsToExcludeForReadyNasi386 = "i386-freebsd-64int sparc-linux sparc-unknown-linux-gnu x86_64 darwin-thread-multi darwin darwin-x86_64 MSWin32-x86 i86pc-solaris-thread-multi-64int arm-linux armhf-linux powerpc-linux 5.10 5.12 5.14 5.16 5.18 5.20 5.22 5.24 5.26 PreventStandby icudt46b.dat";
my $dirsToExcludeForReadyNasSparc = "i386-freebsd-64int i386 x86_64 darwin-thread-multi darwin darwin-x86_64 arm-linux armhf-linux MSWin32-x86 i86pc-solaris-thread-multi-64int powerpc-linux 5.10 5.12 5.14 5.16 5.18 5.20 5.22 5.24 5.26 PreventStandby icudt46l.dat CGI/Util.pm";
my $dirsToExcludeForReadyNasARM = "i386-freebsd-64int sparc-linux sparc-unknown-linux-gnu armhf-linux i386 x86_64 darwin-thread-multi i86pc-solaris-thread-multi-64int darwin darwin-x86_64 MSWin32-x86 powerpc-linux 5.8 5.12 5.14 5.16 5.18 5.20 5.22 5.24 5.26 PreventStandby icudt46b.dat";
