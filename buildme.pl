...
my $dirsToExcludeForDebianDBDSQLite = "CPAN/DBI.pm CPAN/DBI/ CPAN/arch/.*/DBI.pm CPAN/arch/.*/DBI/ auto/DBI/ CPAN/DBD/SQLite CPAN/arch/.*/DBD/SQLite.pm CPAN/arch/.*/DBD/SQLite auto/DBD/SQLite";
my $dirsToExcludeForARMDeb = "$dirsToExcludeForARMTarball 5.10 5.12 5.14 5.16 5.18 5.20 5.22 5.24 5.26 5.38 5.42 $dirsToExcludeForDebianDBDSQLite";
my $dirsToExcludeForx86_64Deb = "5.10 5.12 5.14 5.16 5.18 5.20 5.22 5.24 5.26 MSWin32-x86-multi-thread MSWin32-x64-multi-thread PreventStandby i386-linux i86pc-solaris-thread-multi-64int darwin darwin-x86_64 sparc-linux arm-linux armhf-linux i386-freebsd-64int powerpc-linux aarch64-linux icudt46b.dat icudt58b.dat $dirsToExcludeForDebianDBDSQLite";
my $dirsToExcludeFori386Deb = "5.10 5.12 5.14 5.16 5.18 5.20 5.22 5.28 5.30 5.32 5.34 5.36 5.38 5.40 5.42 MSWin32-x86-multi-thread MSWin32-x64-multi-thread PreventStandby x86_64-linux i86pc-solaris-thread-multi-64int darwin darwin-x86_64 sparc-linux arm-linux armhf-linux i386-freebsd-64int powerpc-linux aarch64-linux icudt46b.dat icudt58b.dat $dirsToExcludeForDebianDBDSQLite";
