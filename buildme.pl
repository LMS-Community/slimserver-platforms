...
my $dirsToExcludeForFreeBSDTarball = "MSWin32-x86-multi-thread PreventStandby i386-linux x86_64-linux darwin darwin-x86_64 sparc-linux arm-linux powerpc-linux icudt46b.dat";
my $dirsToExcludeForARMTarball = "MSWin32-x86-multi-thread PreventStandby i386-linux x86_64-linux darwin darwin-x86_64 sparc-linux i386-freebsd-64int powerpc-linux icudt46b.dat";
my $dirsToExcludeForPPCTarball = "MSWin32-x86-multi-thread PreventStandby i386-linux x86_64-linux darwin darwin-x86_64 sparc-linux arm-linux i386-freebsd-64int icudt46l.dat";
my $dirsToExcludeForLinuxNoCpanTarball = "i386-freebsd-64int MSWin32-x86-multi-thread darwin darwin-x86_64 i386-linux sparc-linux x86_64-linux arm-linux powerpc-linux /arch/ PreventStandby";
...
my $dirsToExcludeForWin32 = "5.8 5.10 5.12 5.16 5.18 i386-freebsd-64int i386-linux x86_64-linux x86_64-linux-gnu-thread-multi darwin darwin-x86_64 sparc-linux arm-linux powerpc-linux OS/Debian.pm OS/Linux.pm OS/Unix.pm OS/OSX.pm OS/ReadyNAS.pm OS/RedHat.pm OS/Suse.pm OS/SlimService.pm OS/Synology.pm OS/SqueezeOS.pm icudt46b.dat";
my $dirsToExcludeForReadyNasi386 = "i386-freebsd-64int sparc-linux sparc-unknown-linux-gnu x86_64 darwin-thread-multi darwin darwin-x86_64 MSWin32-x86 arm-linux powerpc-linux 5.10 5.12 5.14 5.16 5.18 PreventStandby icudt46b.dat";
my $dirsToExcludeForReadyNasSparc = "i386-freebsd-64int i386 x86_64 darwin-thread-multi darwin darwin-x86_64 arm-linux MSWin32-x86 powerpc-linux 5.10 5.12 5.14 5.16 5.18 PreventStandby icudt46l.dat";
my $dirsToExcludeForReadyNasARM = "i386-freebsd-64int sparc-linux sparc-unknown-linux-gnu i386 x86_64 darwin-thread-multi darwin darwin-x86_64 MSWin32-x86 powerpc-linux 5.8 5.12 5.14 5.16 5.18 PreventStandby icudt46b.dat";
