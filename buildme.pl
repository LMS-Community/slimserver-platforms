...
my $dirsToExcludeForMacOSX = "i386-freebsd-64int i386-linux x86_64-linux x86_64-linux-gnu-thread-multi MSWin32 arm-linux armhf-linux powerpc-linux sparc-linux";
