...
-(void)awakeFromNib
{
	...
	{
		if ([[NSWorkspace sharedWorkspace] isFilePackageAtPath:[currDirectory stringByAppendingPathComponent:@"PreferencePanes/Squeezebox.prefPane"]])
		{
...
-(IBAction)doInstall:(id)sender
{
	...
	NSString *fileInstalled = [[NSString stringWithString:@"/Library/PreferencePanes/Squeezebox.prefPane"] retain];
