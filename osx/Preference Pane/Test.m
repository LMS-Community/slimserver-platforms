...
- (void) awakeFromNib
{
    ...
    NSView *prefView;
    pathToPrefPaneBundle = [[[[NSBundle mainBundle] bundlePath] stringByDeletingLastPathComponent] stringByAppendingPathComponent:@"Squeezebox.prefpane"];
	...
	NSLog(@"Error loading Squeezebox.prefpane.");
    }
}
@end
