...
he.ProblemUninstallingSLIMP3=áòéä áäñøú ääú÷ğä ùì úåëğú SLIMP3:
...
es.SlimDevicesWebSite=Slim Devices/Página Web de Logitech
fr.SlimDevicesWebSite=Site Web Slim Devices/Logitech
he.SlimDevicesWebSite=àúø äàéğèøğè ùì Slim Devices/Logitech
it.SlimDevicesWebSite=Sito Web Slim Devices/Logitech
nl.SlimDevicesWebSite=Slim Devices/Logitech-website

de.SlimServerWebInterface=SlimServer-Web-Benutzeroberfläche
...
he.SlimServerWebInterface=îîù÷ äàéğèøğè ùì SlimServer
...
fr.UninstallSlimServer=Désinstaller SlimServer
he.UninstallSlimServer=äñø àú SlimServer
...
fr.SlimServerTrayTool=Outil de la barre d'état système SlimServer
he.SlimServerTrayTool=ëìé äîâù ùì SlimServer
