...
SERVICE=UEML
CONF_FILES="/etc/uemusiclibrary \
            /c/.uemusiclibrary"
            
PROG_FILES="/etc/frontview/apache/addons/UEML.conf* \
            /etc/frontview/addons/*/UEML \
            /usr/share/uemusiclibrary \
            /usr/share/perl5/Slim \
            /usr/share/doc/uemusiclibrary \
            /etc/default/uemusiclibrary \
            /etc/init.d/uemusiclibrary \
            /usr/sbin/uemusiclibrary*"
