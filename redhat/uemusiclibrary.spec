...
Version:	%{_version}
Release:	%{rpm_release}
Summary:	UE Music Library

Group:		System Environment/Daemons
License:	GPL and proprietary
URL:		http://www.uesmartradio.com
Source0:	%{src_basename}.tgz
Source1:	uemusiclibrary.config
Source2:	uemusiclibrary.init
Source3:	uemusiclibrary.logrotate
...
%description
UE Music Library powers the UE Smart Radio
...
# We cannot use vendor_perl here because it could conflict with
# a parallel installation of LMS
cp -Rp Slim $RPM_BUILD_ROOT%{_datadir}/uemusiclibrary
...
cp -p ueml.pl $RPM_BUILD_ROOT%{_usr}/libexec/uemusiclibrary
